...
describe("modules.core.options #unit", function()
	...
	describe("default values", function()
		...
		it("should set updatetime to 100ms by default", function()
			assert.equals(100, defaults.performance.updatetime)
		end)
		...
		-- File settings
		it("should enable backup by default", function()
			assert.is_true(defaults.files.backup)
		end)

		it("should enable writebackup by default", function()
			assert.is_true(defaults.files.writebackup)
		end)

		it("should enable swapfile by default", function()
			assert.is_true(defaults.files.swapfile)
		end)
