...
describe('event_bus #unit', function()
  ...
  describe('on() - event subscription', function()
    ...
    it('should allow multiple subscriptions to the same event', function()
      ...
      event_bus.on('test_event', function() callback1_called = true end)
      event_bus.on('test_event', function() callback2_called = true end)
  ...
  describe('clear() - clearing subscriptions', function()
    it('should clear all subscriptions', function()
      ...
      event_bus.on('event1', function() callback1_called = true end)
      event_bus.on('event2', function() callback2_called = true end)
    ...
    it('should clear subscriptions for a specific event', function()
      ...
      event_bus.on('event1', function() event1_called = true end)
      event_bus.on('event2', function() event2_called = true end)
