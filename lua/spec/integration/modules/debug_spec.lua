  ...
  describe('keymaps.setup()', function()
    ...
    it('should register F-key keymaps', function()
      ...
      for _, km in ipairs(_G._test_keymaps) do
        if km.lhs == '<F5>' then has_f5 = true end
        if km.lhs == '<F10>' then has_f10 = true end
      end
    ...
    it('should register leader-d keymaps', function()
      ...
      for _, km in ipairs(_G._test_keymaps) do
        if km.lhs == '<leader>db' then has_breakpoint = true end
        if km.lhs == '<leader>dr' then has_repl = true end
      end
