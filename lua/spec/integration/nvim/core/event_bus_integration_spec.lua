...
describe('event_bus #integration', function()
  ...
  describe('multi-event workflows', function()
    ...
    it('should handle concurrent event emissions', function()
      ...
      event_bus.on('increment_a', function() counters.a = counters.a + 1 end)
      event_bus.on('increment_b', function() counters.b = counters.b + 1 end)
      event_bus.on('increment_c', function() counters.c = counters.c + 1 end)
