...
function M.setup()
	...
	keymap("n", "<Space>", "za", vim.tbl_extend("force", opts, { desc = "Editor: Toggle fold" }))

	-- Indent visual selected code without unselecting
	keymap("v", ">", ">gv", vim.tbl_extend("force", opts, { desc = "Editor: Indent right" }))
	keymap("v", "<", "<gv", vim.tbl_extend("force", opts, { desc = "Editor: Indent left" }))
	keymap("v", "=", "=gv", vim.tbl_extend("force", opts, { desc = "Editor: Auto indent" }))
	...
	keymap("v", "<C-X>", '"+x', vim.tbl_extend("force", opts, { desc = "Editor: Cut to clipboard" }))
