...
function M.setup()
	...
	-- ==========================================================================
	-- TELESCOPE KEYMAPS (FZF replacements - exact mappings from old vimrc)
	-- ==========================================================================

	-- Main navigation shortcuts (matching old FZF setup exactly)
	keymap("n", "<C-p>", "<cmd>Telescope git_files<cr>", { desc = "Find git files (FZF :GFiles)" })
	keymap("n", "<C-p>g", "<cmd>Telescope live_grep<cr>", { desc = "Live grep (FZF :Rg)" })
	keymap("n", "<C-p>h", "<cmd>Telescope oldfiles<cr>", { desc = "Recent files (FZF :History)" })
	keymap("n", "<C-p>c", "<cmd>Telescope git_commits<cr>", { desc = "Git commits (FZF :Commits)" })
	keymap("n", "<C-p>a", "<cmd>Telescope commands<cr>", { desc = "Command palette (FZF :Commands)" })

	-- Additional useful mappings
	keymap("n", "<C-p>b", "<cmd>Telescope buffers<cr>", { desc = "Find buffers" })
	keymap("n", "<C-p>f", "<cmd>Telescope find_files<cr>", { desc = "Find all files" })
